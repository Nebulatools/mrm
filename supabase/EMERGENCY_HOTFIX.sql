-- 🚨 EMERGENCY HOTFIX: Resolver Loading Infinito en useAuth
-- ⚠️ PROBLEMA: Tabla user_profiles NO EXISTE → hook useAuth se queda en "Cargando..."
-- ✅ SOLUCIÓN: Crear tabla completa con RLS SIN recursión infinita
--
-- INSTRUCCIONES:
...
CREATE TABLE IF NOT EXISTS user_profiles (
  ...
  empresa TEXT, -- NULL para admin, nombre de empresa para usuarios
...
-- ========================================
-- PASO 2: HABILITAR RLS (SIN RECURSIÓN)
-- ========================================

ALTER TABLE user_profiles ENABLE ROW LEVEL SECURITY;

-- ✅ Política SIMPLE: usuarios ven su propio perfil (sin consultar user_profiles recursivamente)
...
-- ========================================
-- PASO 3: FUNCIONES HELPER (SECURITY DEFINER)
-- ========================================
...
-- ========================================
-- PASO 6: RLS EN ASISTENCIA_DIARIA
-- ========================================
...
-- ========================================
-- PASO 7: ÍNDICES PARA PERFORMANCE
-- ========================================
...
-- ========================================
-- PASO 9: INSERTAR PERFILES EXISTENTES
-- ========================================
...
-- Debe retornar 4 perfiles (admin, monterrey, total, norte)
SELECT
  email,
  role,
